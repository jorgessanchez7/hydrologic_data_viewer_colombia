...
# from ..app import HydrologicDataViewerColombia
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.hydrologic_data_viewer_colombia"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.hydrologic_data_viewer_colombia.tests.tests"

        To run tests in the HydrologicDataViewerColombiaTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydrologic_data_viewer_colombia.tests.tests.HydrologicDataViewerColombiaTestCase"

        To run only the test_if_tethys_platform_is_great function in the HydrologicDataViewerColombiaTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydrologic_data_viewer_colombia.tests.tests.HydrologicDataViewerColombiaTestCase.test_if_tethys_platform_is_great"
...
class HydrologicDataViewerColombiaTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(HydrologicDataViewerColombia)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(HydrologicDataViewerColombia)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/hydrologic-data-viewer-colombia/')  # The final '/' is essential for all pages/controllers
